...
Realizar los siguientes pasos en su
respectivo orden.
...
*/
$resultado=(9/2)+8*2/1-(2+2)+9-8+4/8+8*8-1;
echo "Resolución del ejercicio 5.<br><br>El resultado de la operación (9/2)+8*2/1-(2+2) es ".$resultado.".";
?>